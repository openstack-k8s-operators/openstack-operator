...
export RELATED_IMAGE_IRONIC_API_IMAGE_URL_DEFAULT=quay.io/openstack-k8s-operators/openstack-ironic-api:master-latest
export RELATED_IMAGE_IRONIC_CONDUCTOR_IMAGE_URL_DEFAULT=quay.io/openstack-k8s-operators/openstack-ironic-conductor:master-latest
...
export RELATED_IMAGE_IRONIC_PXE_IMAGE_URL_DEFAULT=quay.io/openstack-k8s-operators/openstack-ironic-pxe:master-latest
