...
require (
	...
	github.com/openstack-k8s-operators/heat-operator/api v0.4.1-0.20240930004042-6e96f1302c91
	...
	github.com/openstack-k8s-operators/test-operator/api v0.0.0-20240927140609-f21dbf07ceab
