...
require (
	...
	github.com/openstack-k8s-operators/heat-operator/api v0.0.0-20230611222327-a1494d5aeb88
	...
	github.com/openstack-k8s-operators/swift-operator/api v0.0.0-20230623065510-60931a8888ec
