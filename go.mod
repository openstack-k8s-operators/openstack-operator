...
require (
	...
	github.com/openstack-k8s-operators/openstack-ansibleee-operator/api v0.3.1-0.20240625203523-f825778ab5a7
	...
	github.com/openstack-k8s-operators/test-operator/api v0.0.0-20240624220645-970e7e844b86
