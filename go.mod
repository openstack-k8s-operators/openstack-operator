...
require (
	...
	github.com/openstack-k8s-operators/glance-operator/api v0.1.1-0.20230824110847-185891d3bd93
	...
	github.com/openstack-k8s-operators/nova-operator/api v0.1.2-0.20230823235418-7a7ada5cbe12
