...
func (in *OpenStackDataPlaneNodeSetStatus) DeepCopyInto(out *OpenStackDataPlaneNodeSetStatus) {
	*out = *in
	...
	if in.SecretDeployment != nil {
		in, out := &in.SecretDeployment, &out.SecretDeployment
		*out = new(SecretDeploymentStatus)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretDeploymentStatus) DeepCopyInto(out *SecretDeploymentStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretDeploymentStatus.
func (in *SecretDeploymentStatus) DeepCopy() *SecretDeploymentStatus {
	if in == nil {
		return nil
	}
	out := new(SecretDeploymentStatus)
