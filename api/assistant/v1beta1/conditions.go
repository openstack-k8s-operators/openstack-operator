...
const (
	...
	OpenStackAssistantReadyErrorMessage = "OpenStack Assistant error occurred %s"

	// OpenStackAssistantExtraConfigWaitingMessage
	OpenStackAssistantExtraConfigWaitingMessage = "Waiting for extraConfig ConfigMap %s"
)
