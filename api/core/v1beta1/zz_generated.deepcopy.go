...
func (in *ApplicationCredentialSection) DeepCopy() *ApplicationCredentialSection {
	...
	out := new(ApplicationCredentialSection)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenStackControlPlaneSpec) DeepCopyInto(out *OpenStackControlPlaneSpec) {
	*out = *in
	...
	if in.MessagingBus != nil {
		in, out := &in.MessagingBus, &out.MessagingBus
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RabbitmqFederationConfig) DeepCopyInto(out *RabbitmqFederationConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RabbitmqFederationConfig.
func (in *RabbitmqFederationConfig) DeepCopy() *RabbitmqFederationConfig {
	if in == nil {
		return nil
	}
	out := new(RabbitmqFederationConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RabbitmqSection) DeepCopyInto(out *RabbitmqSection) {
	*out = *in
	...
	if in.Federation != nil {
		...
		*out = new(map[string]RabbitmqFederationConfig)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]RabbitmqFederationConfig, len(*in))
			for key, val := range *in {
				(*out)[key] = *val.DeepCopy()
			}
		}
...
func (in *TelemetrySection) DeepCopyInto(out *TelemetrySection) {
	*out = *in
	...
	if in.ApplicationCredentialCeilometer != nil {
		in, out := &in.ApplicationCredentialCeilometer, &out.ApplicationCredentialCeilometer
		*out = new(ServiceAppCredSection)
		(*in).DeepCopyInto(*out)
	}
	if in.ApplicationCredentialAodh != nil {
		in, out := &in.ApplicationCredentialAodh, &out.ApplicationCredentialAodh
		*out = new(ServiceAppCredSection)
		(*in).DeepCopyInto(*out)
	}
	if in.ApplicationCredentialCloudKitty != nil {
		in, out := &in.ApplicationCredentialCloudKitty, &out.ApplicationCredentialCloudKitty
		*out = new(ServiceAppCredSection)
		(*in).DeepCopyInto(*out)
	}
}
