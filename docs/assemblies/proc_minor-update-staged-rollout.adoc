...
| *Yes* — create a full `OpenStackDataPlaneDeployment`
|===
...
full dataplane deployment (see <<required-manual-deployments>>),
...
. Create the dataplane update deployment before the final completion step.
