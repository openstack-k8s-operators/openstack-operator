...
| archiveAge
| ArchiveAge defines the minimuma age of the records in days that can be moved to the shadow tables.
| *int
| true
...
| NoVNCProxyServiceTemplate - defines the novvncproxy service dedicated for the cell.
| <<novanovncproxytemplate,NovaNoVNCProxyTemplate>>
| true
