...
func ReconcileApplicationCredentials(
	...
	if !instance.Spec.ApplicationCredential.Enabled {
		log.Info("Global ApplicationCredential disabled; deleting per-service ApplicationCredential CRs")
	...
	svcs := []svcAC{
		...
		},
		{
			"aodh",
			instance.Spec.Telemetry.Enabled &&
				instance.Spec.Telemetry.Template.Autoscaling.Enabled != nil &&
				*instance.Spec.Telemetry.Template.Autoscaling.Enabled,
			instance.Spec.Telemetry.ApplicationCredentialAodh,
		},
		{
			"cloudkitty",
			instance.Spec.Telemetry.Enabled &&
				instance.Spec.Telemetry.Template.CloudKitty.Enabled != nil &&
				*instance.Spec.Telemetry.Template.CloudKitty.Enabled,
