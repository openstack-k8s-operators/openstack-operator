...
func ReconcileWatcher(ctx context.Context, instance *corev1beta1.OpenStackControlPlane, version *corev1beta1.OpenStackVersion, helper *helper.Helper) (ctrl.Result, error) {
	...
	if instance.Spec.Watcher.Template.MessagingBus.Cluster == "" {
		...
		if instance.Spec.Watcher.Template.RabbitMqClusterName != nil && *instance.Spec.Watcher.Template.RabbitMqClusterName != "" {
			...
			instance.Spec.Watcher.Template.MessagingBus.Cluster = "rabbitmq"
		}
	}
	// Clear deprecated field after migration
	if instance.Spec.Watcher.Template.MessagingBus.Cluster != "" {
		instance.Spec.Watcher.Template.RabbitMqClusterName = nil
	}
