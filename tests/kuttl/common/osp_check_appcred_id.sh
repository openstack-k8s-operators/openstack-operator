...
declare -A SERVICES=(
    ...
    # TODO: Add remaining services here (nova, neutron, glance, cinder, placement, barbican, swift proxy, heat api, ironic, ironic-inspector, octavia, designate, watcher, manila, ceilometer)
