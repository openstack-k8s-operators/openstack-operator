...
type Names struct {
	...
	MariaDBName               types.NamespacedName
	MariaDBCell1Name          types.NamespacedName
...
func GetDefaultOpenStackControlPlaneSpec() map[string]interface{} {
	...
	mariadbTemplate := map[string]interface{}{
		names.MariaDBName.Name: map[string]interface{}{
			"storageRequest": "500M",
		},
		names.MariaDBCell1Name.Name: map[string]interface{}{
			"storageRequest": "500M",
		},
	}
