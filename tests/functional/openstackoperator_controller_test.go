...
var _ = Describe("OpenStackOperator controller", func() {
	...
	When("TLS - A public TLS OpenStackControlplane instance is created", func() {
		...
		It("should have the TLS Spec fields defaulted", func() {
			...
			Expect(OSCtlplane.Spec.TLS.Ingress.Cert.Duration.Duration.Hours()).Should(Equal(float64(10950)))
	...
	When("TLS - A TLSe OpenStackControlplane instance is created", func() {
		...
		It("should have the TLS Spec fields set/defaulted", func() {
			...
			Expect(OSCtlplane.Spec.TLS.PodLevel.Internal.Cert.Duration.Duration.Hours()).Should(Equal(float64(10950)))
			...
			Expect(OSCtlplane.Spec.TLS.PodLevel.Ovn.Cert.Duration.Duration.Hours()).Should(Equal(float64(10950)))
		})
	})
