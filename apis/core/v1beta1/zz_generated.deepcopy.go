...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenStackService) DeepCopyInto(out *OpenStackService) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenStackService.
func (in *OpenStackService) DeepCopy() *OpenStackService {
	if in == nil {
		return nil
	}
	out := new(OpenStackService)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenStackVersionSpec) DeepCopyInto(out *OpenStackVersionSpec) {
	*out = *in
	if in.ServiceExcludes != nil {
		in, out := &in.ServiceExcludes, &out.ServiceExcludes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.CinderVolumeExcludes != nil {
		in, out := &in.CinderVolumeExcludes, &out.CinderVolumeExcludes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *OpenStackVersionStatus) DeepCopyInto(out *OpenStackVersionStatus) {
	*out = *in
	if in.ServicesNeedingUpdates != nil {
		in, out := &in.ServicesNeedingUpdates, &out.ServicesNeedingUpdates
		*out = make([]OpenStackService, len(*in))
		copy(*out, *in)
	}
	if in.DeployedVersions != nil {
		in, out := &in.DeployedVersions, &out.DeployedVersions
		*out = make([]OpenStackService, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceVersionURL) DeepCopyInto(out *ServiceVersionURL) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceVersionURL.
func (in *ServiceVersionURL) DeepCopy() *ServiceVersionURL {
	if in == nil {
		return nil
	}
	out := new(ServiceVersionURL)
	in.DeepCopyInto(out)
	return out
}
