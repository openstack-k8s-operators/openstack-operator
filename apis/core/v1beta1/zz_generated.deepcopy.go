...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HorizonOverride) DeepCopyInto(out *HorizonOverride) {
	*out = *in
	if in.Route != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HorizonOverride.
func (in *HorizonOverride) DeepCopy() *HorizonOverride {
	if in == nil {
		return nil
	}
	out := new(HorizonOverride)
	in.DeepCopyInto(out)
	return out
}
