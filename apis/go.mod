...
require (
	...
	github.com/openstack-k8s-operators/placement-operator/api v0.5.1-0.20250415081802-b5f8c7b86b7c
	github.com/openstack-k8s-operators/swift-operator/api v0.6.1-0.20250414203501-8b7484002870
