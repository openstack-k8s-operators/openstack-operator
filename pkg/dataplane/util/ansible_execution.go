...
import (
	...
	ansible "github.com/openstack-k8s-operators/lib-common/modules/ansible"
...
func AnsibleExecution(
	...
	if existingAnsibleEE != nil && existingAnsibleEE.Status.Succeeded > 1 {
		return nil
	}

	ansibleEE := ansible.EEJob{
		Name:      executionName,
	...
	_, err = controllerutil.CreateOrPatch(context.TODO(), helper.GetClient(), aeeJob, func() error {
